> Note: These are steps to comment/uncomment text in vim without a plugin installed.
...
4. `SHIFT + I` (insert mode) (highlighting disappears; only first line will appear to have a cursor; it's OK)
